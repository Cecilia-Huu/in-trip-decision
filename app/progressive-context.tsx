...
const words = {
  zh: { hero:"告诉我，现在怎么啦？", label:"发生什么了？", try:"试试这样说", placeholder:"比如：博物馆没开，我已经走得有点累了……", chips:["原计划去不了了","突然多出时间","今天不想赶了"], submit:"看看下一步 →", missing:"先说说发生了什么。", location:"现在从哪里开始？", locationHint:"知道你大概在哪，我才能判断这一段怎么接。", locate:"📍 使用当前位置", locating:"正在获取位置…", manual:"手动输入位置", failed:"没找到你的位置。", fallback:"手动告诉我你在哪 →", acquired:"✓ 已获取当前位置", edit:"修改", place:"例如：米兰大教堂附近", continue:"继续 →", anchor:"接下来有必须赶到的安排吗？", anchorHint:"比如预约的晚餐、演出、车次。没有也完全没关系。", none:"没有固定安排", add:"＋ 添加安排", time:"时间", plan:"安排 / 地点", invalid:"请填写有效时间和安排名称。", back:"修改刚才那句话" },
